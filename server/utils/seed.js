...
advisorId: advisors[index % advisors.length]._id,
active: true
}));
...
credits: 4,
description: "Advanced client and server web development.",
...
credits: 4,
description: "Database design and database management.",
prerequisites: []
},
{
code: "CSC330",
...
credits: 4,
description: "Planning and management of IT projects.",
prerequisites: []
},
{
code: "ITE321",
...
credits: 4,
description: "Web systems and modern web technologies.",
prerequisites: ["CSC220"]
},
{
code: "ITE340",
...
credits: 4,
description: "User-centered interface and interaction design.",
prerequisites: []
},
{
code: "ITE360",
...
credits: 4,
description: "Enterprise computing and IT infrastructure.",
prerequisites: []
},
{
code: "ITE370",
...
credits: 4,
description: "Administration and management of computer networks.",
prerequisites: []
},
{
code: "ITE380",
...
credits: 4,
description: "Information systems concepts and applications.",
prerequisites: []
},
{
code: "ITE410",
...
credits: 4,
description: "Fundamental cybersecurity principles.",
prerequisites: []
},
{
code: "ITE420",
...
credits: 4,
description: "Information assurance and security controls.",
prerequisites: []
},
{
code: "ITE430",
title: "IT Governance",
credits: 4,
description: "Governance and management of information technology.",
prerequisites: []
},
{
code: "ITE440",
...
credits: 4,
description: "Management of organizational information security.",
...
if (!courseId) {
throw new Error(`Course not found: ${code}`);
}
...
seatsTaken: 0,
addDropOpen: true,
addDropCloseDate: new Date("2026-10-01")
},
{
courseId: getCourseId("CSC220"),
term: "2026-1",
...
seatsTaken: 0,
addDropOpen: true,
addDropCloseDate: new Date("2026-10-02")
},
{
courseId: getCourseId("ITE321"),
term: "2026-1",
...
const offerings = await Offering.insertMany(offeringsData);

console.log("26 sections created for term 2026-1");

return offerings;
};

const seedRecords = async (students, courses) => {
...
const recordCount = studentIndex < 12 ? 13 : 12;

for (let recordIndex = 0; recordIndex < recordCount; recordIndex++) {
const courseIndex = (studentIndex * 3 + recordIndex) % courses.length;
const course = courses[courseIndex];

let grade = gradePool[
(studentIndex * 5 + recordIndex) % gradePool.length
];
...
courseId: course._id,
term: terms[recordIndex % terms.length],
grade
});
}
}
...
console.log("312 completed-course records created");
...
console.log("Creating current registrations...");

const courseMap = new Map();

courses.forEach(course => {
courseMap.set(course.code, course._id.toString());
});

const getOffering = (courseCode, section) => {
...
const csc220B = getOffering("CSC220", "B");
const ite380A = getOffering("ITE380", "A");

const registrationsData = [
{
studentId: students[0]._id,
offeringId: ite380A._id,
term: "2026-1",
status: "registered"
},
{
studentId: students[1]._id,
offeringId: csc220B._id,
term: "2026-1",
status: "registered"
},
{
...
const seatCounts = await Registration.aggregate([
{
$match: {
status: "registered"
}
...
const advisorCount =
await User.countDocuments({ role: "advisor" });
